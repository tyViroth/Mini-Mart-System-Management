...
namespace Mart.UserControls
{
    ...
    public partial class UserControlImportStock : UserControl
    {
        ...
        public static UserControlImportStock _instance;
        public static UserControlImportStock Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new UserControlImportStock();
                return _instance;
            }
        }

        public UserControlImportStock()
        {
            InitializeComponent();
