...
namespace Mart
{
    ...
    {    
        ...
        private void btnSelling_Click(object sender, EventArgs e)
        {
            ...
            if (!mainPanel.Controls.Contains(UserControlSelling.Instance))
            {
                mainPanel.Controls.Add(UserControlSelling.Instance);
                UserControlSelling.Instance.Dock = DockStyle.Fill;
                UserControlSelling.Instance.BringToFront();
            }
            else
            {
                UserControlSelling.Instance.BringToFront();
        ...
        {            
            ...
            {
                mainPanel.Controls.Add(UserControlImportStock.Instance);
                UserControlImportStock.Instance.Dock = DockStyle.Fill;
                UserControlImportStock.Instance.BringToFront();
            }
            else
            {
                UserControlImportStock.Instance.BringToFront();
